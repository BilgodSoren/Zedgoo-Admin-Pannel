...
import UserNothingtoShowFp from './UserNothingFp'; // Optional fallback
...
export default function UserEyeDetails() {
  ...
  return (
    <Box sx={styles.container}>
      <Box sx={styles.editicon} onClick={handleVisibilityToggle}>
      ...
      {!Edit ? (
        <>
          ...
          <Typography variant="h5" fontWeight={600} sx={styles.name}>
            Gavin Kumari
          </Typography>
          <Typography sx={styles.enrollno} fontWeight={400}>
